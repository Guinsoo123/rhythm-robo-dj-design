...
| [02-算法设计 / 人形机器人强化学习预备修](02-算法设计/00-人形机器人强化学习预备修.md) | 数学、机器人控制、强化学习和音乐条件的前置概念 |
| [02-算法设计 / 数学与学习定义证明推导（索引）](02-算法设计/01-数学与学习定义证明推导.md) | 推导系列索引；正文拆为 5 册（Bellman、策略梯度、GAE、PPO 等） |
...
| [03-软件架构 / 强化学习工具链与Ubuntu安装](03-软件架构/00-强化学习工具链与Ubuntu安装.md) | 强化学习工具链、作用说明与 Ubuntu 22.04 安装方式 |
...
| 新手可理解 | 强化学习部分从“状态、动作、奖励、策略”讲起，复杂公式有独立预备修和推导文档承接。 |
...
2. 读 [人形机器人强化学习预备修](02-算法设计/00-人形机器人强化学习预备修.md)，建立数学、机器人控制和 RL 词汇表。
3. 读 [数学与学习定义证明推导](02-算法设计/01-数学与学习定义证明推导.md) 索引，并按分册 00→04 理解 Bellman、策略梯度、GAE、PPO 和控制公式从哪里来。
4. 再读 [摇滚机器人跳舞原理](02-算法设计/README_摇滚机器人跳舞原理.md)，建立物理—音乐—RL 的完整心智模型。
5. 然后读 [强化学习舞蹈控制](02-算法设计/强化学习舞蹈控制.md)，对照架构与工程配置落地实现。
6. 接着读 [强化学习工具链与Ubuntu安装](03-软件架构/00-强化学习工具链与Ubuntu安装.md)，准备本地训练和仿真环境。
7. 再读 [MuJoCo与Conda仿真平台](03-软件架构/MuJoCo与Conda仿真平台.md)，把算法落到软件模块和运行环境。
8. 最后读 [研发里程碑](05-路线图/研发里程碑.md)，按阶段实现和验证。
