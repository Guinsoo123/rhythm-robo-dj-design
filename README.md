...
| [02-算法设计 / 数学与学习定义证明推导](02-算法设计/01-数学与学习定义证明推导.md) | 强化学习核心定义、Bellman、策略梯度、GAE、PPO 与控制相关推导 |
...
3. 读 [数学与学习定义证明推导](02-算法设计/01-数学与学习定义证明推导.md)，理解 Bellman、策略梯度、GAE、PPO 和控制公式从哪里来。
